...
# I Found $200K+ in Free Cloud Credits -- Here's How to Claim Them
...
- **How to claim:** Go to [aws.amazon.com/activate](https://aws.amazon.com/activate/), sign up, and apply. Approval is usually within a few days.
...
**Year 1:** Up to $100,000 in credits
**Year 2:** Up to $100,000 in credits
**Total:** $200,000 over 2 years
...
**How to claim:** Visit [cloud.google.com/startup](https://cloud.google.com/startup) and apply. If you're part of an accelerator in their network, mention it -- approval rates are higher.
...
Azure has two separate programs worth knowing about:
...
- **How to claim:** Go to [azure.microsoft.com/en-us/free/students](https://azure.microsoft.com/en-us/free/students/), sign in with your school email, done. No credit card, no catch.
...
- **How to claim:** Apply at [startups.microsoft.com](https://www.microsoft.com/en-us/startups). Microsoft has made this notably easy to access compared to previous years.
...
- **OSS:** Apply at Vercel's contact page with your open source project link. If your project has meaningful GitHub stars or usage, you'll likely be approved.
...
| Program | Students | Startups | OSS | Credit Card Required |
|---------|----------|----------|-----|---------------------|
| AWS Activate Founders | No | Yes | No | Yes |
| AWS Activate Portfolio | No | Yes | No | Yes |
| Google Cloud for Startups | No | Yes | No | Yes |
| Azure for Students | Yes | No | No | No |
| Microsoft Founders Hub | No | Yes | No | Yes |
| DigitalOcean (GitHub Edu) | Yes | No | No | No |
| Vercel OSS | No | No | Yes | No |
| Railway OSS | No | No | Yes | No |
| Cloudflare Startup | No | Yes | Yes | No |
| Supabase | No | Yes | Yes | No |
| MongoDB Atlas Free | Yes | Yes | Yes | No |
