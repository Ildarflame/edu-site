...
[AWS Activate](/deals/aws-activate) is the gold standard for startup cloud credits. There are two tiers:
...
- **Eligibility:** Must be associated with a qualifying accelerator, incubator, or VC. [Stripe Atlas](/deals/stripe-atlas), Y Combinator, Techstars, and dozens of others qualify.
...
[Azure for Students](/deals/azure-students) has two separate programs worth knowing about:
...
[Vercel](/deals/vercel-pro) sponsors open source projects and offers a startup program.
...
[Railway](/deals/railway-oss) keeps it simple. Sign up with your GitHub account and apply for their open source program.
...
[Cloudflare](/deals/cloudflare-startups) provides its Pro plan free for qualifying open source projects and has a startup program that includes:
...
[Supabase](/deals/supabase-startups) (open source Firebase alternative) offers startup credits through partner programs:
...
Through the GitHub Student Developer Pack, students get $200 in [DigitalOcean](/deals/digitalocean-students) credits.
...
[MongoDB Atlas](/deals/mongodb-students) offers a free M0 cluster that never expires:
...
2. [DigitalOcean](/deals/digitalocean-students) via GitHub Education: $200 (databases)
3. [Vercel](/deals/vercel-pro) free tier (frontend hosting)
4. [MongoDB Atlas](/deals/mongodb-students) free tier (document store)
...
2. [AWS Activate](/deals/aws-activate) Founders: $1,000 (multi-cloud redundancy)
3. [Supabase](/deals/supabase-startups) startup credits: $2,500 (auth + Postgres)
4. [Vercel](/deals/vercel-pro) Pro (frontend)
5. [Stripe Atlas](/deals/stripe-atlas) incorporation: $5,000+ in bundled credits
