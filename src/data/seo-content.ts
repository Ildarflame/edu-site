...
export const GUIDE_SEO: GuideSEO[] = [
  ...
  },
  {
    ...
    title: "GitHub Copilot Student Plan — Free AI Coding (2026)",
    metaDescription: "Get GitHub Copilot free with the Student Developer Pack. AI code completion in VS Code, JetBrains, Neovim. Setup in 5 minutes with .edu email.",
    heading: "GitHub Copilot Free Student Plan",
    intro: "GitHub Copilot is free for verified students through the GitHub Student Developer Pack. Get AI-powered code suggestions in VS Code, JetBrains IDEs, and Neovim — no subscription needed.",
    ...
    faqs: [
      { question: "Is GitHub Copilot really free for students?", answer: "Yes, 100% free. GitHub Copilot Individual is included in the GitHub Student Developer Pack at no cost for verified students." },
      ...
      { question: "What's included in the Copilot student plan?", answer: "You get GitHub Copilot Individual: unlimited code completions, chat, CLI integration, and multi-file editing — the same plan that costs $10/month for others." },
      { question: "How do I activate Copilot after getting the Student Pack?", answer: "Go to github.com/settings/copilot, select 'Enable GitHub Copilot', then install the extension in your editor. It activates automatically with your student account." },
      { question: "Can I use Copilot for homework and university projects?", answer: "Yes. Copilot works with any code. Check your university's academic integrity policy on AI coding assistants, as rules vary by institution." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Figma Free for Students — Education Plan Guide (2026)",
    metaDescription: "Get Figma Education plan free: unlimited projects, team libraries, version history, FigJam. Apply with .edu email. Step-by-step verification guide.",
    heading: "Figma Free for Students: Education Plan",
    intro: "Figma offers the Professional plan free through Figma for Education. Students get unlimited projects, team libraries, branching, and version history — everything you need for design coursework and portfolio projects.",
    ...
    faqs: [
      ...
      { question: "How do I apply for Figma for Education?", answer: "Go to figma.com/education, click 'Get verified', and enter your school email. Approval is usually instant for .edu emails. Non-.edu students may need to upload enrollment documents." },
      { question: "Does Figma Education include FigJam?", answer: "Yes. FigJam (Figma's whiteboard tool) is included free in the Education plan with unlimited boards for brainstorming, wireframing, and collaboration." },
    ],
  },
  {
    slug: "how-to-get-notion-free",
    dealSlug: "notion-education",
    title: "Notion Student Discount — Plus Plan Free (2026)",
    metaDescription: "Get Notion Plus plan free as a student: unlimited blocks, file uploads, 30-day history. Verify with .edu email in 2 minutes. Education plan guide.",
    heading: "Notion Student Discount: Free Plus Plan",
    intro: "Notion offers the Plus plan ($10/month value) completely free for students. Get unlimited blocks, file uploads, and 30-day page history — just verify with your .edu email.",
    ...
    faqs: [
      ...
      { question: "How long does the Notion student plan last?", answer: "The student plan lasts as long as you're enrolled. You need to re-verify annually. After graduation, your workspace downgrades to the free plan." },
      { question: "Can I use Notion student plan for team projects?", answer: "Yes. The Plus plan includes guest collaborators and shared workspaces, making it ideal for group projects and student organizations." },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Do I need a credit card for the free domain?", answer: "No. The Namecheap student domain is completely free with no credit card required. You just need to authenticate via the GitHub Student Developer Pack." },
      { question: "Can I get a free .com domain as a student?", answer: "Not through the GitHub Pack. .com domains aren't included, but .me, .tech, and .co are available free. These are great for portfolios (yourname.me) and projects." },
    ],
  },
  {
