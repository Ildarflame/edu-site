  ...
  return (
    <div className={`relative ${isComparing ? "ring-1 ring-orange-500/40 rounded-2xl" : ""}`}>
      ...
      >
        ...
        {/* Hover step reveal — desktop only */}
        {deal.steps.length > 0 && (
          <div className="hidden md:block absolute inset-x-0 bottom-0 px-4 py-3 bg-gradient-to-t from-zinc-950 via-zinc-950/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
